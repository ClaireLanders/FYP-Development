...
// Note: Uses laptop's IP address for Android tablet development
// Centralises API configuration for the entire app

import axios, { AxiosRequestConfig } from 'axios';

// This is my laptop's ip address - for working with the android tablet
export const API_BASE_URL = 'http://192.168.68.59:8001';
