// Hook for accessing theme-specific colors
// Returns appropriate color based on current color scheme (light/dark)
// Allows component-specific color overrides
// Used by themed components to get proper colors
// This file is adapted from the default Expo app (Expo, 2024)
