// Hook for accessing device color scheme (light/dark mode)
// Export of React Native's useColorScheme hook
// Used by components to adapt to system theme preferences
