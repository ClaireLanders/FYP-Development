// Custom hook for fetching products by branch
// Retrieves all products available at a specific branch
// Manages loading state and error handling
// Used by the listing creation form to show available products
