...
// Branch IDs - TODO: Replace with actual user context/authentication
export const BRANCH_IDS = {
  // For creating listings (store worker)
  STORE_BRANCH_ID: '03a897a0-e271-4174-aed2-d283a888dbae',
  STORE_USER_BRANCH_ID: '0ca58dd2-df98-42ee-b0a4-f6b43c00a3d8',

  // For claiming listings (charity volunteer)
  CHARITY_USER_BRANCH_ID: '10e30991-20d0-4580-a48e-6664cab10323',
};
